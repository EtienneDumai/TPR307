...
JOIN TRAJET T ON P.Plnum = T.Plnum
GROUP BY P.Plnom, P.Plprenom, T.Volnum;

-- Question 12
SELECT DISTINCT A.Avnum, A.Avnom 
FROM AVION A
JOIN TRAJET T ON A.Avnum = T.Avnum;

-- Question 13
SELECT COUNT(Volnum) FROM TRAJET;

-- Question 14
SELECT COUNT(Capacite) FROM AVION;

-- Question 15
SELECT AVG(T.HEUREARR - T.HEUREDEP) FROM TRAJET T;

-- Question 16
SELECT MIN(A.CAPACITE), MAX (A.CAPACITE) FROM AVION A;

-- Question 17
SELECT  SUM(HEUREARR-HEUREDEP) AS heuresDeVol FROM TRAJET T
